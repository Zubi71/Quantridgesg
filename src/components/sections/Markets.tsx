...
const Markets = () => (
  <section id="markets" className="section-padding bg-white overflow-hidden relative z-10">
    <div className="max-w-7xl mx-auto relative z-10">
      ...
      >
        <motion.p variants={fadeUpItem} className="text-gold font-bold text-[10px] uppercase tracking-[0.5em] mb-6">Global Reach</motion.p>
        <motion.h2 variants={fadeUpItem} className="text-4xl md:text-5xl lg:text-7xl font-serif text-navy mb-8">Dynamic Markets.</motion.h2>
        <motion.div variants={fadeUpItem} className="h-px w-24 bg-gold/20 mx-auto mb-10" />
        <motion.p variants={fadeUpItem} className="text-navy/60 text-xl leading-relaxed font-light max-w-2xl mx-auto">
        ...
        <motion.div variants={fadeUpItem} className="flex flex-wrap gap-4 sm:gap-6 justify-center mb-20 shrink-0">
          <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={reveal} transition={{ duration: 0.5, ease: easeOut }} className="text-center flex-1 min-w-[140px] max-w-[200px] sm:flex-none px-8 sm:px-10 py-6 sm:py-8 bg-navy text-white rounded-sm shadow-xl shadow-navy/10">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={reveal} transition={{ duration: 0.5, delay: 0.08, ease: easeOut }} className="text-center flex-1 min-w-[140px] max-w-[200px] sm:flex-none px-8 sm:px-10 py-6 sm:py-8 bg-white border border-gray-100 rounded-sm">

...
const Hero = () => {
  return (
    <section className="relative min-h-[100dvh] min-h-screen pt-[calc(7rem+env(safe-area-inset-top,0px))] sm:pt-[calc(8.75rem+env(safe-area-inset-top,0px))] pb-12 sm:pb-16 md:pb-20 overflow-hidden bg-white">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 md:px-10 lg:px-12 grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center relative z-10">
        <motion.div
          className="mt-4 sm:mt-8 lg:mt-0"
          initial="hidden"
          animate="visible"
        ...
        >
          ...
          <motion.h1
            variants={fadeUpItem}
            className="text-[2rem] min-[400px]:text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-serif text-navy leading-[1.08] sm:leading-[1.05] mb-6 sm:mb-8 tracking-tighter text-balance"
          >
            Precision in <br />
            <span className="italic text-gold">Complexity.</span>
          </motion.h1>
          <motion.p
            variants={fadeUpItem}
        ...
        >
          <div className="relative z-10 bg-white p-8 xl:p-12 border border-gray-100 rounded-sm shadow-sm">
            <div className="flex justify-between items-end mb-12">
              <div>
                <p className="text-[10px] uppercase tracking-[0.3em] text-gold font-bold mb-2">Market Volatility Index</p>
                <p className="text-3xl font-serif text-navy">Global Alpha Stream</p>
              </div>
            ...
            <div className="h-64 flex items-end gap-3">
              {[40, 70, 45, 90, 65, 80, 55, 95, 75, 85].map((h, i) => (
                <motion.div
                  ...
                  className={`flex-1 rounded-t-sm transition-colors duration-500 hover:bg-gold ${i % 3 === 0 ? 'bg-gold/80' : 'bg-navy/10'}`}
                />
              ))}
            </div>
          </div>
          <div className="absolute -top-6 -right-6 w-32 h-32 border-t border-r border-gold/20 -z-10" />
          <div className="absolute -bottom-6 -left-6 w-32 h-32 border-b border-l border-navy/10 -z-10" />
        </motion.div>
      </div>
    </section>
  );
    ...
    <section className="section-padding bg-white relative z-10">
      <div className="max-w-4xl mx-auto text-center px-3 sm:px-4">
        ...
        >
          ...
          <motion.h2 variants={fadeUpItem} className="text-3xl sm:text-4xl md:text-5xl font-serif text-navy mb-6 md:mb-8 text-balance px-1">
